defmodule WhimsyWeb.UserAuthTest do
  use WhimsyWeb.ConnCase, async: true

  alias Whimsy.Accounts
  alias Whimsy.Accounts.Scope
  alias WhimsyWeb.UserAuth

  import Whimsy.AccountsFixtures

  @remember_me_cookie "_whimsy_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, WhimsyWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
